...
const binaryPath = resolve(outputRoot, 'holo-supervisor')
const initrdPath = resolve(outputRoot, 'holo-supervisor.cpio')
const selftestPath = resolve(outputRoot, 'holo-selftest')
const sources = [
  'fuse-bridge.c',
  'main.c',
  'protocol.c',
...
const initrd = Buffer.concat([
  newcEntry({ bytes: binary, mode: 0o100755, name: 'holo-supervisor' }),
  ...(selftest == null ? [] : [newcEntry({ bytes: selftest, mode: 0o100755, name: 'holo-selftest' })]),
