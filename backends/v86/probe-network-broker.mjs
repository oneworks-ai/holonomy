...
import { NodeProcessProviderV1 } from '../../adapters/node/src/capability-process-provider.mjs'
import { createV86ProcessBackendV1 } from '../../adapters/node/src/capability-process-v86-backend.mjs'
import { NodeV86ProcessNetworkBrokerV1 } from '../../adapters/node/src/capability-process-v86-network-broker.mjs'
...
const main = async () => {
  ...
  const profile = {
    ...
    executables: [{
      executable: { kind: 'guestPath', path: '/usr/bin/holo-v86-selftest' },
