...
export class WebBodyController {
  ...
  constructor(
    private readonly source: WebBodySource | undefined,
  ...
  private finish() {
    ...
    try {
      ...
      // Capability cleanup cannot replace the already selected body terminal.
    }
  }
}
