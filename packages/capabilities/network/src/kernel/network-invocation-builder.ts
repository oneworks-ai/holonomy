import { canonicalizeNetworkResource } from '@holonomyjs/runtime/kernel/canonical-resources'
import { invalidPolicy } from '@holonomyjs/runtime/kernel/errors'
import { boundedText, identifier, integer } from '@holonomyjs/runtime/kernel/validation'
