import { FACADE_DELIVERY_REGISTRY_V1 } from '@holonomyjs/runtime/kernel/facade-delivery'
import { allOf, inheritedCapability, operation } from '@holonomyjs/runtime/kernel/operation-types'
import type { OperationDescriptorV1 } from '@holonomyjs/runtime/kernel/operation-types'
...
export const PROCESS_OPERATION_REGISTRY_V1: readonly OperationDescriptorV1[] = Object.freeze([
  operation({
    argsSchemaId: 'ProcessDescendantAuthorizationArgsV1',
    capability: allOf('process-descendant-exec', 'host.process.execute'),
    ...
    resourceSchemaId: 'ProcessExecutableResourceV1',
    resultSchemaId: 'ProcessDescendantAuthorizationReceiptV1'
  }),
  operation({
