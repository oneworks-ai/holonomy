...
} from '@holonomyjs/runtime/kernel/resource-types'
import { digest, resourceDisplay } from '@holonomyjs/runtime/kernel/resource-validation'
import { identifier, integer, literal, string } from '@holonomyjs/runtime/kernel/validation'
...
export const canonicalizeProcessNetworkEndpointResource = (
  ...
  const transport = literal(input.transport, ['tcp', 'tls', 'udp'])
  const semanticResourceDigest = canonicalDigest([
