...
import { SYSTEM_INFORMATION_FIELDS_V1 } from '@holonomyjs/runtime/kernel/registry-types'
import type { SystemInformationFieldV1 } from '@holonomyjs/runtime/kernel/registry-types'
import { deepFreeze, exact, literal, record, required } from '@holonomyjs/runtime/kernel/validation'
