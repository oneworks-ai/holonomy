import { encodeUtf8 } from '@holonomyjs/capability-network/web/utf8'

import type { NetworkMockRuleStore } from '@holonomyjs/capability-network/web/network-rules'
import type { NetworkMockRuleSet } from '@holonomyjs/capability-network/web/types'
