import { FS_CAPABILITY_MATRIX } from '@holonomyjs/capability-fs/node/index'
import { WEB_NETWORK_CAPABILITY_MATRIX } from '@holonomyjs/capability-network/web/index'
import { CHILD_PROCESS_CAPABILITY_MATRIX } from '@holonomyjs/capability-process/legacy/index'
