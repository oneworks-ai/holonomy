import { DEVICE_CONTRACT_V1_SCHEMA } from '@holonomyjs/capability-device/kernel/device-schema'
import { PROCESS_BACKEND_DESCRIPTOR_V1_SCHEMA } from '@holonomyjs/capability-process/kernel/process-backend'
import { PROCESS_BACKEND_PROBE_EVIDENCE_V1_SCHEMA } from '@holonomyjs/capability-process/kernel/process-backend-probe-schema'
