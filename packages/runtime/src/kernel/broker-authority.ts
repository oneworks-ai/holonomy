import { bindInvocationResource } from '@holonomyjs/capability-process/kernel/canonical-process-resources'
...
export const createProviderAuthorityV1 = (
  ...
  const invocationBinding = bindInvocationResource({
    ...
    ...(input.subrequestId == null ? {} : { subrequestId: input.subrequestId })
  })
