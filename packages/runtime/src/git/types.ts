import type { FsAuthorityInput, FsPermission } from '@holonomyjs/capability-fs/node/types'
import type { NetworkAuthority, ResolvedNetworkAuthority } from '@holonomyjs/capability-network/web/types'
...
export interface GitAuthority {
  ...
  readonly filesystem: Readonly<import('@holonomyjs/capability-fs/node/types').FsAuthority>
