export type RuntimeStreamErrorCode =
  | 'ERR_MOBILE_STREAM_ABORTED'
  | 'ERR_MOBILE_STREAM_INVALID_ARGUMENT'
  | 'ERR_MOBILE_STREAM_INVALID_STATE'
  | 'ERR_MOBILE_STREAM_NOT_SUPPORTED'
  | 'ERR_MOBILE_STREAM_PREMATURE_CLOSE'
...
export const invalidStreamArgument = (message: string): RuntimeStreamError =>
  new RuntimeStreamError('ERR_MOBILE_STREAM_INVALID_ARGUMENT', message)

export const invalidStreamState = (message: string): RuntimeStreamError =>
  new RuntimeStreamError('ERR_MOBILE_STREAM_INVALID_STATE', message)
...
export const streamAborted = (): RuntimeStreamError =>
  new RuntimeStreamError('ERR_MOBILE_STREAM_ABORTED', 'The stream was aborted')
