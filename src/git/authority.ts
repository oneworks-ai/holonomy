...
import { authorizeFsPath, createFsAuthority } from '../node-fs/authority.js'
import { parseFsPath } from '../node-fs/path.js'
import { authorizeNetworkUrl, resolveNetworkAuthority } from '../web-network/authority.js'
...
import type { FsPermission } from '../node-fs/types.js'
import type {
  AuthorizedGitPath,
  GitAuthority,
  GitAuthorityInput,
