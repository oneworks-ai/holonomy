...
import { encodeBase64 } from '../node-compat/encoding.js'
import { capabilityTextEncodingV1, capabilityTextPathV1 } from './guest-facade-support.js'
...
export const fsReadOptionsV1 = (value: unknown, async: boolean): JsonValueV1 => {
...
export const fsWriteOptionsV1 = (value: unknown, async: boolean): JsonValueV1 => {
  const source = value === undefined || value === null
    ? {}
    : typeof value === 'string'
    ? { encoding: value }
