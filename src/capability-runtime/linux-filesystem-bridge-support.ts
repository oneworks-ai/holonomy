...
import { decodeBase64, encodeBase64 } from '../node-compat/encoding.js'
import type { LinuxFilesystemBridgeInputV1 } from './linux-filesystem-bridge.js'
import type { ProcessMountPolicyV2 } from './policy-process-types.js'

export const linuxFilesystemFailure = (message: string, errno = 5): Error =>
  Object.assign(new Error(message), { errno })
